...
- We are using [`cabal-gild`](https://github.com/tfausak/cabal-gild) to format and generate module lists of cabal files. Make sure all the `.cabal` files are formatted.
- We strongly recommend to use the [pre-commit][pre-commit] tool.
  ...
  + Runs cabal-gild if it's in `$PATH`.
...
[issue]: https://github.com/deepflowinc-oss/elgenerics/issues
[pulls]: https://github.com/deepflowinc-oss/elgenerics/pulls
